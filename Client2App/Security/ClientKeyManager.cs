...
namespace Client2App.Security
{
    internal class ClientKeyManager
    {
        ...
        public void SetCaPublicKey(string base64)
        {
            ...
            _ = Convert.FromBase64String(base64.Trim());
        ...
        // =====================================================
        // SESSION KEY (Ks) – mevcut akışın aynen kalsın
        // =====================================================
        ...
        public byte[] DecryptSessionKeyWithClientPrivateKey(byte[] encryptedSessionKey)
            => DecryptBytesWithMyPrivateKey(encryptedSessionKey);
    }
}
